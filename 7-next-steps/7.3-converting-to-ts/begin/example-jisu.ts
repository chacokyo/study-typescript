import { calculateTriangleArea } from './triangle-jisu'
...
console.log(`Triangle 영역: ${calculateTriangleArea(4, 2)}`) // 두 번째 인자가 없음
logAddress({ street: '성북동', city: '서울', zip: 1004 }) // zip 코드가 없음
